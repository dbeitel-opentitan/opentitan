...
package top_darjeeling_pkg;
  ...
  typedef enum int unsigned {
    TopDarjeelingAlertPeripheralGpio = 0,
    TopDarjeelingAlertPeripheralRvTimer = 1,
    TopDarjeelingAlertPeripheralPwrmgrAon = 2,
    TopDarjeelingAlertPeripheralRstmgrAon = 3,
    TopDarjeelingAlertPeripheralClkmgrAon = 4,
    TopDarjeelingAlertPeripheralPinmuxAon = 5,
    TopDarjeelingAlertPeripheralAonTimerAon = 6,
    TopDarjeelingAlertPeripheralSramCtrlRetAon = 7,
    TopDarjeelingAlertPeripheralRvDm = 8,
    TopDarjeelingAlertPeripheralRvPlic = 9,
    TopDarjeelingAlertPeripheralOtbn = 10,
    TopDarjeelingAlertPeripheralSramCtrlMain = 11,
    TopDarjeelingAlertPeripheralSramCtrlMbox = 12,
    TopDarjeelingAlertPeripheralRvCoreIbex = 13,
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdPwrmgrAonFatalFault = 2,
    TopDarjeelingAlertIdRstmgrAonFatalFault = 3,
    TopDarjeelingAlertIdRstmgrAonFatalCnstyFault = 4,
    TopDarjeelingAlertIdClkmgrAonRecovFault = 5,
    TopDarjeelingAlertIdClkmgrAonFatalFault = 6,
    TopDarjeelingAlertIdPinmuxAonFatalFault = 7,
    TopDarjeelingAlertIdAonTimerAonFatalFault = 8,
    TopDarjeelingAlertIdSramCtrlRetAonFatalError = 9,
    TopDarjeelingAlertIdRvDmFatalFault = 10,
    TopDarjeelingAlertIdRvPlicFatalFault = 11,
    TopDarjeelingAlertIdOtbnFatal = 12,
    TopDarjeelingAlertIdOtbnRecov = 13,
    TopDarjeelingAlertIdSramCtrlMainFatalError = 14,
    TopDarjeelingAlertIdSramCtrlMboxFatalError = 15,
    TopDarjeelingAlertIdRvCoreIbexFatalSwErr = 16,
    TopDarjeelingAlertIdRvCoreIbexRecovSwErr = 17,
    TopDarjeelingAlertIdRvCoreIbexFatalHwErr = 18,
    TopDarjeelingAlertIdRvCoreIbexRecovHwErr = 19,
