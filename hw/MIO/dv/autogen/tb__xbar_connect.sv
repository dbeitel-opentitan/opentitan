...
tl_if mbx__hst_tl_if(clk_main, rst_n);
tl_if dma__hst_tl_if(clk_main, rst_n);
...
`ifndef GATE_LEVEL
    ...
    `DRIVE_CHIP_TL_HOST_IF(mbx__hst, sram_ctrl_mbox, ram_tl)
    `DRIVE_CHIP_TL_HOST_IF(dma__hst, sram_ctrl_mbox, ram_tl)
