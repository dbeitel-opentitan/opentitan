...
`CONNECT_TL_HOST_IF(mbx__hst, dut, clk_main_i, rst_n)
`CONNECT_TL_HOST_IF(dma__hst, dut, clk_main_i, rst_n)
...
`CONNECT_TL_DEVICE_IF(mbx__dev, dut, clk_main_i, rst_n)
`CONNECT_TL_DEVICE_IF(dma__dev, dut, clk_main_i, rst_n)
`CONNECT_TL_DEVICE_IF(dbgctlhstreg__dev, dut, clk_main_i, rst_n)
`CONNECT_TL_DEVICE_IF(dbgctlmbxmem__dev, dut, clk_main_i, rst_n)
`CONNECT_TL_DEVICE_IF(extr__dev, dut, clk_main_i, rst_n)
