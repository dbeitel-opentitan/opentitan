...
`ifndef GATE_LEVEL
  ...
  bind xbar_main tlul_assert #(.EndpointType("Host")) tlul_assert_device_dbgctlhstreg__dev (
    .clk_i  (clk_main_i),
    .rst_ni (rst_main_ni),
    .h2d    (tl_dbgctlhstreg__dev_o),
    .d2h    (tl_dbgctlhstreg__dev_i)
  );
  bind xbar_main tlul_assert #(.EndpointType("Host")) tlul_assert_device_dbgctlmbxmem__dev (
    .clk_i  (clk_main_i),
    .rst_ni (rst_main_ni),
    .h2d    (tl_dbgctlmbxmem__dev_o),
    .d2h    (tl_dbgctlmbxmem__dev_i)
  );
