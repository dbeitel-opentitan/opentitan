...
package rstmgr_reg_pkg;
  ...
  } rstmgr_reg2hw_alert_test_reg_t;  // register struct

  typedef struct packed {
    logic [3:0]  q;
  } rstmgr_reg2hw_reset_req_reg_t;  // register struct
  ...
  } rstmgr_reg2hw_reset_info_reg_t;  // register struct
  ...
  } rstmgr_reg2hw_alert_info_ctrl_reg_t;  // register struct
  ...
  } rstmgr_reg2hw_cpu_info_ctrl_reg_t;  // register struct

  typedef struct packed {
    logic        q;
  } rstmgr_reg2hw_sw_rst_ctrl_n_mreg_t;  // register struct
  ...
  } rstmgr_reg2hw_err_code_reg_t;  // register struct
  ...
  typedef struct packed {
    struct packed {
      logic        d;
      logic        de;
    } LOW_POWER_EXIT; // field struct type2
    struct packed {
      logic        d;
      logic        de;
    } SW_RESET; // field struct type2
    struct packed {
      logic [3:0]  d;
      logic        de;
    } HW_REQ; // field struct type2
  ...
  typedef struct packed {
    ...
    struct packed {
      logic        d;
      logic        de;
    } RESET_CONSISTENCY_ERR; // field struct type2
    struct packed {
      logic        d;
      logic        de;
    } FSM_ERR; // field struct type2
