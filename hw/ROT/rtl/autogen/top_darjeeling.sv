...
module top_darjeeling #(
  ...
  // Multiplexed I/O
  input        [2:0]  mio_in_i,
  output logic [2:0]  mio_out_o,
  output logic [2:0]  mio_oe_o,
  // Dedicated I/O
  input        [10:0] dio_in_i,
  output logic [10:0] dio_out_o,
  output logic [10:0] dio_oe_o,
...
// pragma coverage off
    ...
    assign unused_cg_en_10 = clkmgr_aon_cg_en.io_div2_peri;
    prim_mubi_pkg::mubi4_t unused_cg_en_11;
    assign unused_cg_en_11 = clkmgr_aon_cg_en.usb_peri;
    ...
    assign unused_rst_en_37 = rstmgr_aon_rst_en.i2c1[rstmgr_pkg::Domain0Sel];
    prim_mubi_pkg::mubi4_t unused_rst_en_38;
    assign unused_rst_en_38 = rstmgr_aon_rst_en.i2c2[rstmgr_pkg::DomainAonSel];
    prim_mubi_pkg::mubi4_t unused_rst_en_39;
    assign unused_rst_en_39 = rstmgr_aon_rst_en.i2c2[rstmgr_pkg::Domain0Sel];
//VCS coverage on
// pragma coverage on
  ...
  aes #(
    ...
    .RndCnstMaskingLfsrPerm(RndCnstAesMaskingLfsrPerm)
      ...
      // [24]: recov_ctrl_update_err
      // [25]: fatal_fault
      .alert_tx_o  ( alert_tx[25:24] ),
      .alert_rx_i  ( alert_rx[25:24] ),
  ...
  assign intr_vector = {
      ...
      intr_entropy_src_es_fatal_err, // IDs [95 +: 1]
      intr_entropy_src_es_observe_fifo_ready, // IDs [94 +: 1]
      intr_entropy_src_es_health_test_failed, // IDs [93 +: 1]
      intr_entropy_src_es_entropy_valid, // IDs [92 +: 1]
      intr_csrng_cs_fatal_err, // IDs [91 +: 1]
      intr_csrng_cs_hw_inst_exc, // IDs [90 +: 1]
      intr_csrng_cs_entropy_req, // IDs [89 +: 1]
      intr_csrng_cs_cmd_req_done, // IDs [88 +: 1]
      intr_keymgr_op_done, // IDs [87 +: 1]
      intr_otbn_done, // IDs [86 +: 1]
      intr_kmac_kmac_err, // IDs [85 +: 1]
      intr_kmac_fifo_empty, // IDs [84 +: 1]
      intr_kmac_kmac_done, // IDs [83 +: 1]
      intr_hmac_hmac_err, // IDs [82 +: 1]
      intr_hmac_fifo_empty, // IDs [81 +: 1]
      intr_hmac_hmac_done, // IDs [80 +: 1]
...
rotAlertPacker  (/*AUTOINST*/);
  ...
  // Pinmux connections
  // All muxed inputs
  assign cio_spi_device_sd_p2d[0] = mio_p2d[MioInSpiDeviceSd0];
  assign cio_spi_device_sd_p2d[1] = mio_p2d[MioInSpiDeviceSd1];
  assign cio_spi_device_sd_p2d[2] = mio_p2d[MioInSpiDeviceSd2];
  assign cio_spi_device_sd_p2d[3] = mio_p2d[MioInSpiDeviceSd3];
  ...
  // All muxed outputs
  assign mio_d2p[MioOutSpiDeviceSd0] = cio_spi_device_sd_d2p[0];
  assign mio_d2p[MioOutSpiDeviceSd1] = cio_spi_device_sd_d2p[1];
  assign mio_d2p[MioOutSpiDeviceSd2] = cio_spi_device_sd_d2p[2];
  assign mio_d2p[MioOutSpiDeviceSd3] = cio_spi_device_sd_d2p[3];
  ...
  assign mio_en_d2p[MioOutSpiDeviceSd0] = cio_spi_device_sd_en_d2p[0];
  assign mio_en_d2p[MioOutSpiDeviceSd1] = cio_spi_device_sd_en_d2p[1];
  assign mio_en_d2p[MioOutSpiDeviceSd2] = cio_spi_device_sd_en_d2p[2];
  assign mio_en_d2p[MioOutSpiDeviceSd3] = cio_spi_device_sd_en_d2p[3];
