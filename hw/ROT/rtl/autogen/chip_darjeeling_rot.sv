...
module chip_darjeeling_rot #(
  // Path to a VMEM file containing the contents of the boot ROM, which will be
  // baked into the FPGA bitstream.
  parameter BootRomInitFile = "test_rom_fpga_rot.32.vmem",
  // Path to a VMEM file containing the contents of the emulated OTP, which will be
  // baked into the FPGA bitstream.
  parameter OtpCtrlMemInitFile = "otp_img_fpga_rot.vmem"
) (
  // Dedicated Pads
  inout SPI_Host_BootRoT_CLK, // Dedicated Pad for spi_host0_sck
  inout SPI_Host_BootRoT_CSL, // Dedicated Pad for spi_host0_csb
  inout SPI_Host_BootRoT_D0, // Dedicated Pad for spi_host0_sd
  inout SPI_Host_BootRoT_D1, // Dedicated Pad for spi_host0_sd
  inout SPI_Host_BootRoT_D2, // Dedicated Pad for spi_host0_sd
  inout SPI_Host_BootRoT_D3, // Dedicated Pad for spi_host0_sd
  inout SPI_Device_FWLoad_CLK, // Dedicated Pad for spi_device_sck
  inout SPI_Device_FWLoad_CS_L, // Dedicated Pad for spi_device_csb
  inout UART_ShareROT_FWDebug_TX, // Dedicated Pad for uart0_tx
  inout I2C_BootRoT_SCL, // Dedicated Pad for i2c0_scl
  inout I2C_BootRoT_SDA, // Dedicated Pad for i2c0_sda

  // Muxed Pads
  inout SPI_Device_FWLoad_MOSI, // MIO Pad 0
  inout SPI_Device_FWLoad_MISO, // MIO Pad 1
  inout SPI_Host_BootRoT_RESET_L  // MIO Pad 2
);
  ...
  localparam pinmux_pkg::target_cfg_t PinmuxTargetCfg = '{
    ...
    dio_pad_type: {
      ...
      BidirStd, // DIO spi_device_csb
      BidirStd, // DIO spi_device_sck
  ...
  padring #(
    ...
    .NMioPads(3),
    .DioPadType ({
      BidirStd, // I2C_BootRoT_SDA
      BidirStd, // I2C_BootRoT_SCL
      BidirStd, // UART_ShareROT_FWDebug_TX
      BidirStd, // SPI_Device_FWLoad_CS_L
      BidirStd, // SPI_Device_FWLoad_CLK
      BidirStd, // SPI_Host_BootRoT_D3
      BidirStd, // SPI_Host_BootRoT_D2
      BidirStd, // SPI_Host_BootRoT_D1
      BidirStd, // SPI_Host_BootRoT_D0
      BidirStd, // SPI_Host_BootRoT_CSL
      BidirStd  // SPI_Host_BootRoT_CLK
    }),
    .MioPadType ({
      BidirStd, // SPI_Host_BootRoT_RESET_L
      BidirStd, // SPI_Device_FWLoad_MISO
      BidirStd  // SPI_Device_FWLoad_MOSI
    })
  ) u_padring (
  // This is only used for scan and DFT purposes
    ...
    .dio_pad_io ({
      I2C_BootRoT_SDA,
      I2C_BootRoT_SCL,
      UART_ShareROT_FWDebug_TX,
      SPI_Device_FWLoad_CS_L,
      SPI_Device_FWLoad_CLK,
      SPI_Host_BootRoT_D3,
      SPI_Host_BootRoT_D2,
      SPI_Host_BootRoT_D1,
      SPI_Host_BootRoT_D0,
      SPI_Host_BootRoT_CSL,
      SPI_Host_BootRoT_CLK
    }),

    .mio_pad_io ({
      SPI_Host_BootRoT_RESET_L,
      SPI_Device_FWLoad_MISO,
      SPI_Device_FWLoad_MOSI
    }),
    ...
    .mio_in_o (mio_in[2:0]),
    .mio_out_i (mio_out[2:0]),
    .mio_oe_i (mio_oe[2:0]),
    .mio_attr_i (mio_attr[2:0]),
    .mio_in_raw_o (mio_in_raw[2:0])
  );
