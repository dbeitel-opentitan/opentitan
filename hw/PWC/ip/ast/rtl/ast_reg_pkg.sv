...
package ast_reg_pkg;
  ...
  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega0_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega1_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega2_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega3_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega4_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega5_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega6_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega7_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega8_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega9_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega10_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega11_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega12_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega13_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega14_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega15_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega16_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega17_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega18_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega19_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega20_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega21_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega22_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega23_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega24_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega25_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega26_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega27_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega28_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega29_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega30_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega31_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega32_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega33_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega34_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega35_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega36_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_rega37_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
    logic        qe;
  } ast_reg2hw_regal_reg_t;  // register struct

  typedef struct packed {
    logic [31:0] q;
  } ast_reg2hw_regb_mreg_t;  // register struct
